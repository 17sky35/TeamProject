            ...
            >
                ...
                <div
                    style={{
                        ...
                        flexWrap: "wrap",
                        gap: "10px",
                        marginTop: "30px", // 폴더 위치를 아래로 내리기 위해 margin-top 추가
                    }}
                >
                    {folders.map((folder) => (
                        <div
                            key={folder.id}
                            style={{
                                width: "calc(20% - 10px)", // 한 줄에 3개 배치
                                aspectRatio: "2.5 / 3", // 2.5:3 비율 유지
                                backgroundColor: "#fff",
                                border: "1px solid #ccc",
                                borderRadius: "8px",
                                display: "flex",
                                flexDirection: "column", // 폴더 안의 내용 세로로 배치
                        ...
                        >
                            ...
                            >
                                <input
                                    style={{
                                        ...
                                        height: "18px", // 체크박스 크기조정
                                    }}
                                    type="checkbox"
                                    checked={folder.checked}
                                    onChange={(e) => handleCheckboxChange(folder.id,e)}
                                />
                            </div>
                            ...
                            <input
                                ...
                                placeholder="타이틀 입력"
                                value={folder.title}
                                onChange={(e) => handleTitleChange(folder.id, e.target.value)}
                                style={{
                                    width: "100%",
                                    marginTop: "10px",
                                    padding: "5px",
